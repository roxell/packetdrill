...
class TestSet(object):
    ...
    def RunTests(self, path):
        ...
        print (
            ...
            % (
                self.num_pass + self.num_fail + self.num_timedout,
                self.num_pass,
                self.num_fail,
                self.num_timedout,
...
def ParseArgs():
    ...
    args.add_argument(
        "-l", "--log_on_error", action="store_true", help="requires verbose"
    )
    args.add_argument(
        "-L", "--log_on_success", action="store_true", help="requires verbose"
    )
